...
htmxpatterns = [
    ...
    path('library/show_quiztasks/<int:pool_id>', views.show_quiztasks, name='get_quiztasks'),
    ...
    # Answers
    path('library/show_answers/<int:task_id>', views.show_answers, name='get_answers'),
